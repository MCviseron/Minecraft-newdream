...
execute as @a at @s if score wintimer wintimer matches 1 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 1 run gamemode adventure @a[team=green]
execute as @a at @s if score wintimer wintimer matches 20 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 40 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 60 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 80 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 100 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 120 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 140 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 160 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 180 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
execute as @a at @s if score wintimer wintimer matches 200 run title @s title [{"text": "猎人胜利！","color": "red","bold":true}]
